function get_sets()
    ...
    sets.perpetuation = {main='Chatoyant Staff', ammo='Seraphicaller', head='Con. Horn +1', neck="Caller's Pendant", lear='Ruby Earring', rear='Moonshade Earring', body='Glyphic Doublet +1', hands='Adhara Gages', rring="Evoker's Ring", back='Conveyance Cape', waist='Mujin Obi', legs='Nares Trews', feet='Con. Pigaches +1'}
    sets.perpetuation['Carbuncle'] = {main='Chatoyant Staff', ammo='Seraphicaller', head='Con. Horn +1', neck="Caller's Pendant", lear='Ruby Earring', rear='Moonshade Earring', body='Hagondes Coat +1', hands='Carbuncle Mitts', rring="Evoker's Ring", back='Conveyance Cape', waist='Mujin Obi', legs='Nares Trews', feet='Mdk. Crackows +1'}
    sets.perpetuation['Cait Sith'] = {main='Chatoyant Staff', ammo='Seraphicaller', head='Con. Horn +1', neck="Caller's Pendant", lear='Ruby Earring', rear='Moonshade Earring', body='Hagondes Coat +1', hands='Adhara Gages', rring="Evoker's Ring", back='Conveyance Cape', waist='Mujin Obi', legs='Nares Trews', feet='Con. Pigaches +1'}
    sets.perpetuation['Fenrir'] = {main='Chatoyant Staff', ammo='Seraphicaller', head='Con. Horn +1', neck="Caller's Pendant", lear='Ruby Earring', rear='Moonshade Earring', body='Glyphic Doublet +1', hands='Glyphic Bracers +1', rring="Evoker's Ring", back='Conveyance Cape', waist='Mujin Obi', legs='Nares Trews', feet='Con. Pigaches +1'}
    sets.perpetuation['Garuda'] = {main='Vayuvata III', ammo='Seraphicaller', head='Con. Horn +1', neck="Caller's Pendant", lear='Ruby Earring', rear='Moonshade Earring', body='Hagondes Coat +1', hands='Adhara Gages', rring="Evoker's Ring", back='Conveyance Cape', waist='Mujin Obi', legs='Nares Trews', feet='Con. Pigaches +1'}
    sets.perpetuation['Ramuh'] = {main='Apamajas III', ammo='Seraphicaller', head='Con. Horn +1', neck="Caller's Pendant", lear='Ruby Earring', rear='Moonshade Earring', body='Hagondes Coat +1', hands='Adhara Gages', rring="Evoker's Ring", back='Conveyance Cape', waist='Mujin Obi', legs='Nares Trews', feet='Con. Pigaches +1'}
    ...
    sets.pet_midcast.magical.attack = {main='Astralwatcher', head='Glyphic Horn', neck='Eidolon Pendant', body='Con. Doublet +1', hands='Nares Cuffs', back="Tiresias' Cape", waist="Caller's Sash", legs="Ngen Seraweels", feet='Hag. Sabots +1'}
