function get_sets()
    ...
    sets.idle = {main='Eminent Staff', sub='Elementa Grip', ammo='Mana Ampulla', head='Wayfarer Circlet', neck='Quanpur Necklace', lear='Strophadic Earring', rear='Moldavite Earring', body='Wayfarer Robe', hands='Wayfarer Cuffs', lring='Strendu Ring', rring="Balrahn's Ring", back='Vita Cape', waist='Sekhmet Corset', legs='Wayfarer Slops', feet='Wayfarer Clogs'}
